...
def sample_repo_map():
    ...
    return {
        "metadata": {"url": "https://example.com/user/repo", "version": "0.1.0"},
        "structure": {
            "src": {
                "main.py": {"type": "blob", "path": "src/main.py", "mode": "100644"}
            },
            "README.md": {"type": "blob", "path": "README.md", "mode": "100644"},
        },
        "ast_data": {"src/main.py": {"type": "module", "children": []}},
    }
